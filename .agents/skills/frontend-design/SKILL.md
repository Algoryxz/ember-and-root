...
> **EMBER & ROOT PRECEDENCE & RELATIONSHIP NOTICE:**
> In this repository, design authority resolves in this strict order:
> 1. `AGENTS.md`
> 2. Official product documents (`docs/PRD.md`, `docs/TRD.md`, `docs/UI_UX_BRIEF.md`, `docs/APP_FLOW.md`, `docs/BACKEND_SCHEMA.md`, `docs/CONTRACTS.md`)
> 3. Project-specific skills (`ember-ui`, `reward-integrity`, `integration-guardian`, `ship-check`)
> 4. Reusable external skills (`frontend-design`, `animate`, `theme-factory`)
>
> **Role Division:**
...
>
> If `frontend-design` says something stylistically different from the Ember & Root brief: **EMBER & ROOT WINS**.
> `frontend-design` must never invent a different product identity. The product identity is frozen: **"Illuminated field journal"**.
